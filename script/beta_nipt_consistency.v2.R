...
pdf(paste0("S3_beta",".pdf"),width=19,height=28)
#tiff(paste0("beta_nipt_consistency",".tiff"),width=17,height=30,units='in',res=600,compression='jpeg',family='myCustomWindowsFontName')
