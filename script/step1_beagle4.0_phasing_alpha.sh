...
perl /THL4/home/bgi_guofengyu/work/haplotyping/script/aratio_filter.pl /THL4/home/bgi_guofengyu/work/haplotyping/freq/selected_1M.chr16.freq.txt $fam_vcf ${prefix}.filter.vcf.gz
...
vcf-merge $popu_vcf ${prefix}.fam.filter.alpha.vcf.gz|bgzip -c > ${prefix}.fam.merge.vcf.gz
if [ $? -ne 0 ]; then
